                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    ...
                                    <p style="font-size:15px; color:#44455f; margin:8px 0 0; line-height:24px;">
                                        Vous avez un message de la platforme "Go with dog<br>.</p>
                                    <span
                                    ...
                                    <p
                                        style="color:#455056; font-size:18px;line-height:20px; margin:0; font-weight: 500;">
                                        <strong
                                            style="display: block; font-size: 13px; margin: 24px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);">Sujet</strong><span
                                            style="color: #44455f;">{{ $subject }}</span>
                                    </p>
                                    <p
                                        style="color:#455056; font-size:18px;line-height:20px; margin:0; font-weight: 500;">
                                        <strong
                                            style="display: block; font-size: 13px; margin: 24px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);">Message</strong><span
                                            style="color: #44455f;">{{ $contenu }}</span>
                                    </p>
